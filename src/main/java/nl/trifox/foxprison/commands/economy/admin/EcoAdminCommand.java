package nl.trifox.foxprison.commands.economy.admin;
...
public class EcoAdminCommand extends AbstractAsyncCommand {
    ...
    private static class EcoSetCommand extends AbstractAsyncCommand {
        ...
        protected CompletableFuture<Void> executeAsync(CommandContext ctx) {
            ...
            return CompletableFuture.runAsync(() -> {
                ...
                double oldBalance = FoxPrisonPlugin.getInstance().getEconomy().getBalance(playerRef.getUuid());
                FoxPrisonPlugin.getInstance().getEconomy().setBalance(playerRef.getUuid(), amount, "Admin set");
    ...
    private static class EcoGiveCommand extends AbstractAsyncCommand {
        ...
        protected CompletableFuture<Void> executeAsync(CommandContext ctx) {
            ...
            return CompletableFuture.runAsync(() -> {
                ...
                FoxPrisonPlugin.getInstance().getEconomy().deposit(playerRef.getUuid(), amount, "Admin give");
                double newBalance = FoxPrisonPlugin.getInstance().getEconomy().getBalance(playerRef.getUuid());
    ...
    private static class EcoTakeCommand extends AbstractAsyncCommand {
        ...
        protected CompletableFuture<Void> executeAsync(CommandContext ctx) {
            ...
            return CompletableFuture.runAsync(() -> {
                ...
                boolean success = FoxPrisonPlugin.getInstance().getEconomy().withdraw(playerRef.getUuid(), amount, "Admin take");
                double newBalance = FoxPrisonPlugin.getInstance().getEconomy().getBalance(playerRef.getUuid());
    ...
    private static class EcoResetCommand extends AbstractAsyncCommand {
        ...
        protected CompletableFuture<Void> executeAsync(CommandContext ctx) {
            ...
            return CompletableFuture.runAsync(() -> {
                ...
                FoxPrisonPlugin.getInstance().getEconomy().setBalance(playerRef.getUuid(), startingBalance, "Admin reset");
    ...
    private static class EcoSaveCommand extends AbstractAsyncCommand {
        ...
        @Override
        protected CompletableFuture<Void> executeAsync(CommandContext ctx) {
            FoxPrisonPlugin.getInstance().getEconomy().forceSave();
